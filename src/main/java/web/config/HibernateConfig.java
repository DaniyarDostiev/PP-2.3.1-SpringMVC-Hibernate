...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityFactory() {
        ...
        entityFactory.setPersistenceUnitName("myJpaPersistenceUnit");
    ...
    public PlatformTransactionManager transactionManager() {
        JpaTransactionManager transactionManager = new JpaTransactionManager(getEntityFactory().getObject());
